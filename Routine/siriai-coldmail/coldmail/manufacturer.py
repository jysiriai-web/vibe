...
KEYWORDS = [
    # 화학·원료·제조 (소비자 브랜드명엔 거의 안 쓰임 = 오삭제 위험 낮음)
    "화학", "케미칼", "chemical", "소재", "원료", "제조", "oem", "odm", "합성",
    "켐", "유화", "정밀화학", "향장", "공업", "머티리얼", "케미",
    # 제약·바이오·생명과학 (제조사 신호)
    "제약", "약품", "파마", "pharma", "바이오", "bio", "생명과학", "생명공학",
    "메디칼", "메디컬", "medical",
    # OEM/ODM 화장품 제조사
    "콜마", "kolmar", "케이씨아이", "kci", "코스메카", "인터코스",
    "코스맥스", "cosmax", "잉글우드", "메가코스", "크로다", "croda",
    "코스비전", "코스모코스", "코스텍",
]
